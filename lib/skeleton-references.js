...
export async function getSkeletonReferences(){
  ...
  const url=API+'?action=query&generator=search&gsrsearch=skeleton%20human%20anatomy&gsrnamespace=6&gsrlimit=170&prop=imageinfo&iiprop=url|mime|extmetadata&iiurlwidth=640&format=json&origin=*';
  try{
