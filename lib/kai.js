...
// Vendor APIs are the normal KAI chain. Google is intentionally kept
// outside this list as the emergency provider; KAI-51 remains last resort.
const VENDOR_PROVIDERS = ['OpenAI', 'Groq', 'Mistral', 'OpenRouter', 'Hugging Face'];
