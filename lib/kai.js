const DEFAULT_ORDER = ['openai', 'google', 'groq', 'mistral', 'openrouter', 'huggingface'];

// Provider aliases/availability are resolved at request time. A missing or rejected
// provider is skipped automatically, so one bad key cannot block the whole router.
const MODELS = {
  openai: 'gpt-4o-mini',
